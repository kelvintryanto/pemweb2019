										...
										<div class="card-body">
											<div class="col-md-12" style="margin-left: -20px">
												<div class="col-md-12">
													...
													<input class="col-md-10" type="text" name="name" id="name" style="margin-left: 5px" />
												</div>
												<div class="col-md-12">
													<label for="name">Email</label>
													<input class="col-md-10" type="text" name="name" id="name" style="margin-left: 10px"/>
												</div>
												<div class="col-md-12">
													<label for="name">No.Hp</label>
													<input class="col-md-10" type="text" name="name" id="name" style="margin-left: 3px"/>
												</div>											
											</div>										
